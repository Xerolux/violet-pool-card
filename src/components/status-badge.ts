 ...
 *
 * Component: Status Badge - shows the current operating status of a pool device
...
export class StatusBadge extends LitElement {
  ...
  protected render(): TemplateResult {
    ...
    return html` <div class="badge ${this.state} ${this.pulse ? 'pulse' : ''}" style="--badge-color: ${config.color}" role="status" aria-label="${displayLabel}" > ${this.showIcon ? html`<ha-icon icon="${displayIcon}" aria-hidden="true"></ha-icon>` : ''}
