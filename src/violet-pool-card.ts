...
interface LovelaceCardConfig {
  ...
  entity?: string;
  entities?: string[];
  card_type: 'pump' | 'heater' | 'solar' | 'dosing' | 'overview' | 'compact' | 'system' | 'details' | 'chemical' | 'sensor' | 'cover' | 'light' | 'filter' | 'backwash' | 'refill' | 'solar_surplus' | 'flow_rate' | 'inlet' | 'counter_current' | 'chlorine_canister' | 'ph_plus_canister' | 'ph_minus_canister' | 'flocculant_canister' | 'statistics' | 'weather' | 'maintenance' | 'alerts' | 'comparison';
  name?: string;
  icon?: string;
